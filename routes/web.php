...
Route::put('courses/edit/{course}', [CourseController::class, 'edit'])->name('edit.course');
Route::put('courses/update/{course}', [CourseController::class, 'update'])->name('update.course');
